...
class Tkinter_GUI:
    def __init__(self, root):
        ...
        self.database_entry = tk.StringVar()
        self.observer = None
    ...
    def create_widgets(self):
        ...
        # Create a text box for event logging at row 1
        self.events_textbox = CTkTextbox(self.frame4, width=750, height=200)
        self.events_textbox.grid(row=1, column=0, padx=10, pady=10, sticky="nsew")
    ...
    def stop_monitoring(self):
        ...
        try:
            self.observer.stop()
            self.events_textbox.insert(tk.END, "Monitoring stopped.\n")
            self.events_textbox.see(tk.END)
        except AttributeError:
            self.events_textbox.insert(tk.END, "Observer not running.\n")
            self.events_textbox.see(tk.END)
